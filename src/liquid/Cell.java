...
public class Cell {
	...
	public static final ColorFloat LIGHT_COLOR = new ColorFloat(0.6f, 0.8f, 1f);
	public static final ColorFloat DARK_COLOR = new ColorFloat(0, 0.5f, 0.9f);
	...
	public final ColorFloat color = new ColorFloat();
	...
	public void update() {
		...
		this.color.setLerp(LIGHT_COLOR, DARK_COLOR, liquid / 4f);
	}
